...
//		System.out.println("--------------------------");
				...
				buff.append("<td><a href=\"#m"
						...
						+ (description != null && description.length() > 0 ? "(\""
								...
								+ (null == testInstanceName ? "" : "<br>("
										...
										+ "<td class=\"log\"><a href=\"" + currentPath + "/logs\" target=\"_blank\" type=\"text/plain\">show log</a>"+"</td>"+ "</tr>");
	...
	private void startResultSummaryTable(String style) {
		...
		writer.println("<tr><th>Class</th>"
				+ "<th>Method</th><th>Exception Info</th><th>Start Time </th><th>Execution Time<br/>(hh:mm:ss)</th><th>Log</th></tr>");
		m_row = 0;
	}
